...
class TestContextModule(unittest.TestCase):
    ...
    def test_create_place_info_response(self, mock_llm):
        ...
        mock_response.content = "The Portland Library is located at 123 Main St and is open until 5pm."
    ...
    def test_lookup_place_info(self, mock_create_response, mock_places_tool, mock_extract_name):
