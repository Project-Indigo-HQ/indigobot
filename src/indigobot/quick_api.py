...
def get_conversation_id(request: Request):
    """Function acquires conversation ID from request for rate limiting"""
...
def send_message_to_chatwoot(conversation_id, message):
    """Returns message from model back to inbox


    :param conversation_id: ID for chatwoot inbox
    :param message: message generated by RAG model
    """
